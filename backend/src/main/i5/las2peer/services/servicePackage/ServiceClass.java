...
@Path("example")
@Version("0.1")
@ApiInfo(title = "LAS2peer Template Service",
    description = "A LAS2peer Template Service for demonstration purposes.",
    termsOfServiceUrl = "http://your-terms-of-service-url.com", contact = "john.doe@provider.com",
    license = "BSD License", licenseUrl = "http://your-software-license-url.com")
